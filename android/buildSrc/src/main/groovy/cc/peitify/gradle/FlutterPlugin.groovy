...
class FlutterPlugin implements Plugin<Project> {
    ...
    private void configurePluginProject(String pluginName, String _) {
        ...
        project.logger.error(">>> peiwei >>> configurePluginProject :$pluginName .")
...
//            project.dependencies.add("${buildType.name}Embed", "io.flutter:flutter_embedding_$flutterBuildMode:$engineVersion")
    ...
    private static void addEmbedDependencies(Project project, String variantName, Object dependency, Closure config = null) {
        project.dependencies.add("${variantName}Embed", dependency, config)
    }
    ...
    private boolean isFlutterPortalProject() {
        return project.name == "Flutter"
    }
